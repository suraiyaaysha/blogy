                        ...
                        <div class="blog-intro-area-bottom">
                            <div class="intro-start">
                                ...
                                <div class="intro-start-release d-flex">
                                    <div>
                                        <span class="dot"></span>
                                        <span class="intro-start-time">{{ $post->updated_at->format('F j, Y') }}</span>
                                    </div>
                                    <div>
                                        <span class="dot"></span>
                                        <span class="intro-start-time">{{ $post->reading_duration }} {{ __('read') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="intro-end">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4 mb-md-0 mb-lg-0">
                            <div class="blog-item">
                                ...
                                <div class="blog-item-info">
                                    ...
                                    <h5><a href="{{ url('/posts/'.$relatedPost->slug) }}">{{ Str::limit($relatedPost->title, 20) }}</a></h5>
                                    <div class="blog-item-info-release">
                                        <span>{{ $relatedPost->created_at->format('F j, Y') }}</span> <span class="dot"></span> <span>{{ $relatedPost->reading_duration }} {{ __('read') }}</span>
                                    </div>
                                    <a href="{{ url('/posts/'.$relatedPost->slug) }}" class="btn btn-link">{{ __('Read Article') }}
