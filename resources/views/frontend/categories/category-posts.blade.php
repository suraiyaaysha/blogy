                        ...
                        <div class="col-lg-4 col-md-6 mt-4">
                            <div class="blog-item blog-item-sm">
                                ...
                                <div class="blog-item-info">
                                    ...
                                    <h5><a href="{{ url('/categories/'.$category->slug.'/'.$post->slug) }}">{{ Str::limit($post->title, 15) }}</a></h5>
                                    ...
                                    <a href="{{ url('/categories/'.$category->slug.'/'.$post->slug) }}" class="btn btn-link">{{ __('Read Article') }}
